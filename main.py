...
def fim_do_jogo():
    ...
    if jogador_voce > jogador_pc:
        app_vencedor = Label(frame_baixo, text="VOCÊ VENCEU, PARABÉNS", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co6)
        app_vencedor.place(x=15, y=60)
    elif jogador_voce < jogador_pc:
        app_vencedor = Label(frame_baixo, text="MELHORE, VOCÊ PERDEU", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co6)
        app_vencedor.place(x=15, y=60)
    else:
        app_vencedor = Label(frame_baixo, text="EMPATE", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co6)
        app_vencedor.place(x=15, y=60)
    ...
    b_jogar_denovo = Button(frame_baixo,command=jogar_denovo, width=30, text='Jogar Novamente',  bg=co6, fg=co0, font=('Ivy 10 bold'), anchor=CENTER, relief=RAISED, overrelief=RIDGE)
    b_jogar_denovo.place(x=5, y=151)

b_jogar = Button(frame_baixo,command=iniciar_jogo, width=30, text='JOGAR',  bg=co6, fg=co0, font=('Ivy 10 bold'), anchor=CENTER, relief=RAISED, overrelief=RIDGE)
